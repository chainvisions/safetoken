...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.safefactory = new this.web3.Contract(SafeFactoryABI)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.safefactory, contractAddress.safeFactory[networkId])
  }

  setDefaultAccount(account) {
    this.safefactory.options.from = account
  }
